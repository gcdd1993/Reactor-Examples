...
public class SampleConsumer {
    ...
    public Disposable consumeMessages(String topic, CountDownLatch latch, Consumer<String> consumer) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Disposable disposable = consumer.consumeMessages(TOPIC, latch, msg -> {
            System.out.println("customer consumer of " + msg);
        });
